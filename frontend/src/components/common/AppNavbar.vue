  ...
  <nav class="navbar" :class="{ scrolled: isScrolled }">
    <div class="container nav-inner">
      ...
      <div class="nav-links">
        ...
        <RouterLink to="/theaters" class="nav-link">Theater Shows</RouterLink>
        <RouterLink v-if="auth.isAdmin" to="/theaters/add" class="btn btn-ghost btn-sm">+ Add Theater Show</RouterLink>
